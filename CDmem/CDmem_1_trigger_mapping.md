...
Sent when the sense of control rating scale appears ("How much control did you feel...").

| Trigger | Meaning |
|---------|---------|
| **91** | Agency rating screen onset — **low** control condition |
| **92** | Agency rating screen onset — **high** control condition |
