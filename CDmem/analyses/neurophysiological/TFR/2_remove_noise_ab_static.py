...
WORKFLOW (two-pass):
    ...
    Pass 2 — CLEANING MODE:
        ...
        5. Saves cleaned epochs to eeg3_clean_alphabeta_static/
...
INPUTS:
    - Epoch files: eeg2_ica_alphabeta_static/CDmem_XXXX-epo.fif
    - ICA files:   eeg2_ica_alphabeta_static/CDmem_XXXX-ica.fif

OUTPUTS:
    - Cleaned epochs: eeg3_clean_alphabeta_static/CDmem_XXXX-epo.fif
    - Exclusion log:  eeg3_clean_alphabeta_static/exclusionrate.json
"""
...
# ──────────────────────────────────────────────────────────────
plist = [4,6,7,8,9,10,12,13,14,15,16,19,20,21,22]
# plist = [15]
...
component_exclusions = {
    ...
    16: [0,1],
    # 17: [0,1],
    19: [0,1,2,3,8,11,12,14,15,16,18,19],
    20: [0,1,3,13,14,18],
    21: [0,1,7,10,16],
    22: [0,1]
...
# Paths
# ──────────────────────────────────────────────────────────────
input_path  = r"H:\PHD\control_detection\main_data\eeg\eeg2_ica_alphabeta_static"
output_path = r"H:\PHD\control_detection\main_data\eeg\eeg3_clean_alphabeta_static"
