...
if n_subs < 2:
    ...
    print("  Individual participant results are saved in eeg4_alphabeta_static/.")
    ...
    for condition in ['low', 'high']:
        ...
        # Restrict strictly to 0.0 to 3.5s window
        time_mask = (times >= 0.0) & (times <= 3.5)
        times = times[time_mask]
        recalled_arr = recalled_arr[:, time_mask]
        not_recalled_arr = not_recalled_arr[:, time_mask]
