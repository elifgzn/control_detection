...
PURPOSE:
    ...
    time-frequency analysis. It epochs around STIMULUS ONSET (S 31-34)
...
WHAT IT DOES (step by step):
    ...
    9. Saves epochs + ICA to eeg2_ica_alphabeta_static/
...
OUTPUTS:
    - Epoch files: H:/PHD/control_detection/main_data/eeg/eeg2_ica_alphabeta_static/CDmem_XXXX-epo.fif
    - ICA files:   H:/PHD/control_detection/main_data/eeg/eeg2_ica_alphabeta_static/CDmem_XXXX-ica.fif

DIFFERENCES FROM 1_import_raw.py:
    - Epochs locked to S 31-34 (stimulus onset) instead of S 21-24 (movement onset)
    - Longer epoch window: -0.5 to +5.5s instead of -2.5 to +2.5s
    - Output folder: eeg2_ica_alphabeta_static/ instead of eeg2_ica/
...
plist = [18,23,24]  # <-- change this as needed
...
output_path = r"H:\PHD\control_detection\main_data\eeg\eeg2_ica_alphabeta_static"
...
for sub in plist:
    ...
    try:
        ...
        wanted_triggers = ['Stimulus/S 31', 'Stimulus/S 32', 'Stimulus/S 33', 'Stimulus/S 34']
        triggers = {}
        ...
        # Save to eeg2_ica_alphabeta_static/ (separate from movement-onset epochs).
