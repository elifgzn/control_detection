...
BEHAVIORAL LOGIC:
    During encoding, participants see two images but only control one. 
    A trial is classified as "recalled" (hit) or "not-recalled" (miss) 
    STRICTLY based on whether they successfully recognized the CONTROLLED 
    image during the subsequent recognition phase. The memory outcome of 
    the distractor (uncontrolled) image is ignored for this analysis.
